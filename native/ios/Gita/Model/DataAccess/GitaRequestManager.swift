...
//		https://bhagavadgita.dev.nativemind.net/help/api/
//


final class GitaRequestManager: RequestManager {
	
	static let kHostUrl: String = "https://app.bhagavadgitaapp.online"
//	static let kHostUrl: String = "https://bhagavadgita.dev.nativemind.net"
